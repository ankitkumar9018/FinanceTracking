"""Angel One broker adapter — stub implementation."""
...
_NOT_IMPLEMENTED_MSG = "Angel One integration coming soon"


class AngelOneBroker(BrokerAdapter):
    """Angel One stub adapter — all methods raise ``NotImplementedError``."""
